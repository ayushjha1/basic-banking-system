...
<head>
    ...
    define('bankName', 'Sparks Project : UMO Bank',true);
...
<body style="background: url(images/6.jpg);background-size: 100%">
<h1 class="alert alert-success rounded-0"><?php echo bankname; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:ayush kumar</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
